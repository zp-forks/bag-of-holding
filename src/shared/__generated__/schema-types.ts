...
export type ResolversTypes = ResolversObject<{
  ...
  AddItemResult:
    ...
    | ResolversTypes['CampaignNotFound'];
  AddTagResult:
    | ResolversTypes['Campaign']
    | ResolversTypes['CampaignNotFound']
    | ResolversTypes['ItemNotFound'];
...
export type ResolversParentTypes = ResolversObject<{
  ...
  Int: Scalars['Int'];
  AddItemResult:
    | ResolversParentTypes['Campaign']
    | ResolversParentTypes['CampaignNotFound'];
  AddTagResult:
    | ResolversParentTypes['Campaign']
    | ResolversParentTypes['CampaignNotFound']
    | ResolversParentTypes['ItemNotFound'];
  Campaign: Campaign;
  ID: Scalars['ID'];
  ...
  EditItemResult:
    | ResolversParentTypes['Campaign']
    | ResolversParentTypes['CampaignNotFound']
    | ResolversParentTypes['InvalidInput'];
  FetchCampaignResult:
    | ResolversParentTypes['Campaign']
    | ResolversParentTypes['CampaignNotFound'];
...
export type AddItemResultResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes['AddItemResult'],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    'Campaign' | 'CampaignNotFound',
    ParentType,
    ContextType
  >;
}>;

export type AddTagResultResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes['AddTagResult'],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    'Campaign' | 'CampaignNotFound' | 'ItemNotFound',
    ParentType,
    ContextType
  >;
}>;
...
export type CampaignResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes['Campaign'],
> = ResolversObject<{
...
export type CampaignNotFoundResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes['CampaignNotFound'],
> = ResolversObject<{
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type CreatedCampaignResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes['CreatedCampaign'],
> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type EditItemResultResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes['EditItemResult'],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    'Campaign' | 'CampaignNotFound' | 'InvalidInput',
    ParentType,
    ContextType
  >;
}>;

export type FetchCampaignResultResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes['FetchCampaignResult'],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    'Campaign' | 'CampaignNotFound',
    ParentType,
...
export type InvalidInputResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes['InvalidInput'],
> = ResolversObject<{
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type ItemResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes['Item'],
> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type ItemNotFoundResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes['ItemNotFound'],
> = ResolversObject<{
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type ModifyMoneyResultResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes['ModifyMoneyResult'],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    'Campaign' | 'CampaignNotFound',
    ParentType,
...
> = ResolversObject<{
  createCampaign?: Resolver<
    ResolversTypes['CreatedCampaign'],
    ParentType,
    ContextType,
    RequireFields<MutationCreateCampaignArgs, 'name'>
  >;
  addItem?: Resolver<
    ResolversTypes['AddItemResult'],
    ParentType,
    ContextType,
    RequireFields<MutationAddItemArgs, 'id' | 'input'>
  >;
  removeItem?: Resolver<
    ResolversTypes['RemoveItemResult'],
    ParentType,
    ContextType,
    RequireFields<MutationRemoveItemArgs, 'id' | 'input'>
  >;
  editItem?: Resolver<
    ResolversTypes['EditItemResult'],
    ParentType,
    ContextType,
    RequireFields<MutationEditItemArgs, 'id' | 'input'>
  >;
  modifyMoney?: Resolver<
    ResolversTypes['ModifyMoneyResult'],
    ParentType,
    ContextType,
    RequireFields<MutationModifyMoneyArgs, 'id' | 'input'>
  >;
  addTag?: Resolver<
    ResolversTypes['AddTagResult'],
    ParentType,
    ContextType,
    RequireFields<MutationAddTagArgs, 'campaignId' | 'itemId' | 'tag'>
  >;
  removeTag?: Resolver<
    ResolversTypes['RemoveTagResult'],
    ParentType,
    ContextType,
    RequireFields<MutationRemoveTagArgs, 'campaignId' | 'itemId' | 'tag'>
  >;
}>;
...
> = ResolversObject<{
  listCampaigns?: Resolver<
    Array<Maybe<ResolversTypes['Campaign']>>,
    ParentType,
    ContextType
  >;
  fetchCampaign?: Resolver<
    ResolversTypes['FetchCampaignResult'],
    ParentType,
    ContextType,
    RequireFields<QueryFetchCampaignArgs, 'id'>
  >;
}>;

export type RemoveItemResultResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes['RemoveItemResult'],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    'Campaign' | 'CampaignNotFound',
    ParentType,
...
export type RemoveTagResultResolvers<
  ContextType = any,
  ParentType = ResolversParentTypes['RemoveTagResult'],
> = ResolversObject<{
  __resolveType: TypeResolveFn<
    'Campaign' | 'CampaignNotFound' | 'ItemNotFound',
    ParentType,
